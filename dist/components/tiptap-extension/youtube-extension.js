...
const YOUTUBE_REGEX_GLOBAL = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be|youtube-nocookie\.com)\/(?!channel\/)(?!@)(.+)?$/g;
...
const getEmbedUrlFromYoutubeUrl = (options) => {
    ...
    const videoIdRegex = /(?:v=|shorts\/|embed\/)([a-zA-Z0-9_-]+)/;
...
//# sourceMappingURL=youtube-extension.js.map