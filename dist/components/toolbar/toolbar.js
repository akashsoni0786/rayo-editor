...
export function Toolbar({ children, className, variant = "fixed", ref, ...props }) {
    ...
    if (!isVisible)
        return null;
    return (_jsx("div", { ref: mergeRefs([toolbarRef, ref]), role: "toolbar", "aria-label": "toolbar", "data-variant": variant, className: `tiptap-toolbar ${className || ""} ${isDragging ? 'is-dragging' : ''}`, style: {
            cursor: isDragging ? 'grabbing' : 'grab',
            userSelect: isDragging ? 'none' : 'auto',
            ...props.style
        }, ...props, children: children }));
}
export function ToolbarGroup({ children, className, ref, ...props }) {
...
export function ToolbarSeparator({ ref, ...props }) {
